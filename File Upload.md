...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%201.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%202.JPG)

## Security Low
- Upload file **php-reverse-shell.php** ke halaman web

![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%203.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%204.JPG)

## Security Medium
- Gunakan tool Burp Suite untuk mengubah **Content-Type: application/x-php** menjadi **Content-Type: image/jpeg**

![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%205.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%206.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%207.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%208.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%209.JPG)

- Upload file gambar tersebut ke halaman **File Upload** dengan security **High**

![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%2010.JPG)

- Buka tool metasploit dengan perintah `msfconsole` di terminal

![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%2011.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%2012.JPG)
...
![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%2013.JPG)

- Metasploit berhasil masuk ke dalam sistem dengan user **www-data**

![alt text](https://github.com/rahardian-dwi-saputra/dvwa-tricks/blob/main/assets/file%20upload/file%20upload%2014.JPG)
